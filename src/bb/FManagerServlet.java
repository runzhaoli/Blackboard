...
/**
 * Servlet implementation class FManagerServlet
 */
@WebServlet("/FManagerServlet")
public class FManagerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FManagerServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("welcome to fmanager!!!");
		String table = "user";
